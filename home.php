...
<section class="category">
   ...
   <h1 class="title">Photographers Category</h1>

   <div class="box-container">

      <a href="category.php?category=wedding" class="box">
         <img src="images/wedding.jpeg" alt="">
         <h3>Wedding</h3>
      </a>

      <a href="category.php?category=potrait" class="box">
         <img src="images/potrait.jpeg" alt="">
         <h3>Potrait</h3>
      </a>
      ...
      <a href="category.php?category=landscape" class="box">
...
<section class="products">
   ...
   <h1 class="title">Latest Photographers</h1>
